...
(function() {
    ...
    let totalMoveCount = 0;              // 双方总移动步数（用于限制“先手优势”只在前三步）
    ...
    // 统一评估白方语音条件
    // movingColor: 本次移动的棋子颜色
    // isCapture: 是否吃子
    // isCheckAfterMove: 移动后是否将军
    // isOpponentBubble: 气泡显示在对手头像（白方自己移动为false，黑方收到对手移动为true）
