// main.js - 无沙漠地面版，保留所有其他优化
(function () {
    // ==================== 全局配置 ====================
    const CONFIG = {
        desert: {
            // 已删除 groundY, groundSize, repeatCount, groundColor, groundRoughness 等地面相关参数
            skyColor: '#1a1a2e',
            fogColor: '#3a2a1a',
            fogDensity: 0.0012,
            ambientColor: '#4a3a2a',
    ...
    async function preloadMoonTexture() {
    ...
    class Player {
        ...
        update(dt, input, worldMeshes, wallMeshes) {
            ...
            // 墙壁碰撞与攀爬（保持原有逻辑，省略重复代码，实际使用时需保留完整）
            const playerBox = {
    ...
    class Game {
        constructor(canvas) {
            ...
            // 没有沙漠地面！没有 groundGroup，没有 desertGround。
    ...
    async function boot() {
        ...
        await preloadMoonTexture();   // 只加载月球纹理
