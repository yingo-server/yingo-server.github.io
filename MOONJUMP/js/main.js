...
(function () {
    ...
    const CONFIG = {
        environment: {
            ...
            platformColor: '#000000',      // 所有平台统一黑色
            goalPlatformColor: '#000000',  // 终点也是黑色
            wallColor: '#3a3a3a',
            cameraGoalHeight: 6,
        },
        menu: {
    ...
    class Game {
        ...
        buildLevel(data) {
            ...
            (data.platforms || []).forEach(p => {
                ...
                if (p.type === 1) edgeColor = '#88aaff';   // 起点淡蓝
                else if (p.type === 2) edgeColor = '#88ffaa'; // 保存点淡绿
                else if (p.type === 3) edgeColor = '#ff8888'; // 终点红
