// main.js - 夜晚沙漠跑酷，2D月球，攀爬，地块提示，跳过按钮，进度保存，垂直分割线动画，关卡标题显示
(function () {
    ...
    class Game {
        ...
        setupInput() {
            ...
            window.addEventListener('mousemove', (e) => { if (mouseDown && this.player) this.player.rotate(e.movementX, e.movementY); });
        ...
        async transitionToNextLevel() {
            ...
            await new Promise(r => setTimeout(r, 1200)); // 等待标题动画完成
            transitionOverlay.style.opacity = '0';
            this.currentLevel++;
            this.loadLevel(this.currentLevel);
            await new Promise(r => setTimeout(r, 500));
            animateDivider();
            await new Promise(r => setTimeout(r, 1300)); // 分割线动画时间
            this.transitioning = false;
        }
    ...
    // 启动流程：logo 4.5s → 黑屏 → 显示关卡标题 → 分割线动画 → 开始游戏
