// main.js - 完整版：2.0 标准支持 + 多语言 tooltip + 严重错误修复 + FPS 鼠标 + 背景音乐 + 增强碰撞
(function () {
    // ==================== 全局配置 ====================
    const CONFIG = {
        desert: {
    ...
    function initBackgroundMusic() {
        try {
            ...
            backgroundMusic.addEventListener('error', (e) => {
                console.warn('背景音乐加载失败:', e.target.error ? e.target.error.message : '未知错误');
            ...
            backgroundMusic.addEventListener('canplaythrough', () => {
                ...
                if (playPromise !== undefined) {
                    playPromise.catch(() => {
                        ...
                        document.addEventListener('touchstart', musicResumeHandler);
                    });
                }
            });
    ...
    class Game {
        ...
        buildFallbackLevel() {
            ...
            mesh.userData.tooltip = ''; mesh.userData.tooltip_en = '';
            mesh.userData.id = '';
        ...
        for (let i = start; i <= end; i++) {
            try {
                ...
                try {
                    ...
                    console.warn(`关卡 ${i} JSON 解析失败:`, parseErr.message);
                    break;
                }
