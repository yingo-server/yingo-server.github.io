// main.js - 夜晚沙漠跑酷，2D月球 Sprite，光晕后置，攀爬系统，关卡开始UI已移除，地块提示保留
(function () {
    ...
    class Game {
        ...
        async loadLevel(levelNum) {
            ...
            try {
                ...
                console.error('关卡加载失败，使用内置默认地图', err);
        ...
        buildFallbackLevel() {
            ...
            ground.userData.isGoal = false;
            ground.userData.tooltip = '默认平台';
        ...
        setupInput() {
            ...
            window.addEventListener('mousemove', (e) => {
                ...
                const dx = e.clientX - this.lastRotation.x;
                const dy = e.clientY - this.lastRotation.y;
                this.player.rotate(dx, dy);
                this.lastRotation = { x: e.clientX, y: e.clientY };
            });
