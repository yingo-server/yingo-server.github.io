// main.js - 夜晚沙漠跑酷，2D月球，攀爬，地块提示，跳过按钮，进度保存，垂直分割线动画
(function () {
    ...
    function animateDivider() {
        ...
        divider.style.background = 'rgba(255, 255, 255, 0.4)';
        divider.style.boxShadow = '0 0 4px rgba(0,120,212,0.3)';
        ...
        setTimeout(() => {
            ...
            const blink = setInterval(() => {
                ...
                count++;
                if (count === 6) { // 闪烁3次（on-off-on-off-on-off）
                    clearInterval(blink);
    ...
    class Game {
        ...
        setupInput() {
            ...
            let mouseDown = false;
            container.addEventListener('mousedown', () => { mouseDown = true; this.lastRotation = { x: 0, y: 0 }; });
