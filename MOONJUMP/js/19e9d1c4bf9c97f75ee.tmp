...
(function () {
    ...
    class Player {
        ...
        update(dt, input, worldMeshes, wallMeshes) {
            ...
            // 墙壁碰撞与攀爬（保持原有逻辑，省略冗长代码，实际使用时需保留完整）
            const playerBox = {
    ...
    class Game {
        ...
        buildLevel(data) {
            ...
            (data.platforms || []).forEach(p => {
                ...
                const color = p.isGoal ? CONFIG.environment.goalPlatformColor : CONFIG.environment.platformColor;
